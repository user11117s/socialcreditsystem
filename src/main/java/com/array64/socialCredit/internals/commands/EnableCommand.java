...
public class EnableCommand extends APICommand {
    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if(!config.isEnabled()) {
            config.enable();
            sender.sendMessage("The Social Credit System has been enabled.");
        } else
            sender.sendMessage("The Social Credit System already is enabled.");
        return true;
    }
