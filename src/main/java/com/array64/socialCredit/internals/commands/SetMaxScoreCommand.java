...
public class SetMaxScoreCommand extends APICommand {
    @Override
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        try {
            ...
            config.setMaxScore(score);
            sender.sendMessage("The maximum score has been successfully set to: " + ChatColor.GOLD + score);
        }
        catch(ScoreOutOfBoundsException ignored) {
            sender.sendMessage(ChatColor.RED + "The score you provided was out of bounds. Please make sure it is non-negative.");
        }
        return true;
    }
